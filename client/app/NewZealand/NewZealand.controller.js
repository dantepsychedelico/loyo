...
.controller('NewZealandPage1', function($scope, $sce, search) {
  ...
  $scope.details = [{
    date: '第 1 天',
    title: '台北/(轉機點)/基督城',
    context: $sce.trustAsHtml('<p>短暫離開平日生活、工作的空間，整裝待發到紐西蘭來一趟悠閒與樂活、OFF慢遊紐西蘭之旅。今日搭乘中華航空豪華噴射班機往紐西蘭南島一大城－基督城，今晚夜宿機上，班機於隔日下午抵達。</p><p>短暫離開平日生活、工作的空間，整裝待發到紐西蘭來一趟悠閒與樂活、OFF慢遊紐西蘭之旅。今日搭乘中華航空豪華噴射班機往紐西蘭南島一大城－基督城，今晚夜宿機上，班機於隔日下午抵達。</p>'),
    remarks: [

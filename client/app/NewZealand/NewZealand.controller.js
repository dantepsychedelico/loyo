...
.controller('NewZealandPage1', function($scope, search) {
  $scope.features = [{
    ...
    remarks: [
      '參加團體，中華航空有特惠價格升等商務客艙優惠專案，歡迎向業務人員洽辦。',
      '歡迎台新無限卡會員升等商務客艙優惠專案，歡迎向業務人員洽辦。'
    ],
    hotel: '夜宿機上',
    breakfast: '敬請自理',
    lunch: '敬請自理',
    ...
    date: '第 2 天',
    title: '基督城',
    context: ' <p>紐西蘭10月起至隔年3月底，是夏令節約時間，時間比台灣快5小時，抵達基督城後已是當地時間傍晚時分，慢遊行程不趕路的原則，晚餐在飯店內享用西式晚餐，不安排任何行程，讓貴賓充分休息，調整時差回復體力，準備隔天精彩活動。</p>',
    slides: [{
      title: '夜晚基督城',
    ...
    context: ' <p>2011基督城地震後，市中心整建中，主要景點值得造訪參觀。早餐專車在▲市中心的觀賞基督城市容現況(開車經過)，整建中的基督城大教堂、大教堂廣場、亞芳河、紙板教堂。隨後下午安排前往◎植物園參觀 ，有很多超過百歲的巨樹，以及優美的園藝花卉讓您目不轉睛的欣賞。夏天到秋天，眾多植物持續開花，植物園景觀生機洋溢、多姿多采。安排★坎特伯里博物館參觀，在館中可觀賞到毛利人早期生活的方式，雕刻、編織等文物及窺見老19世紀基督城老街及交通工具的文明風貌，也可一次飽覽紐西蘭特有的奇異鳥、企鵝、信天翁各種的珍奇鳥類動物。</p> <p>午餐後經前往坎特伯里前往費利小鎮，特別企劃■安排★農莊住宿體驗。團體分組4~6人各自前往農莊，由當地農莊主人招待，實地參觀農場、近距離與飼養的動物合影，每個農莊住宅都有不同的居家特色，每位農莊主人都具備各自的興趣、嗜好，也都很好客、健談。晚餐主人準備紐西蘭式的家常美食招待。(可準備一份小禮物，贈送農莊主人，增加互動機會及建立更多情誼)，請前一天準備過夜簡單手提行李，夜宿農莊。</p>',
    slides: [{
      title: '基督城植物園',
